...
class Kendaraan extends CI_Controller
{
  ...
  public function index()
  {
    ...
    // jika ada input yang dilakukan user
    ...
    $config['base_url'] = 'http://localhost/datakendaraan/kendaraan/index/';
