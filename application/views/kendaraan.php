        ...
        <?php foreach ($kendaraan as $k) : ?>
          <tr>
            ...
            <?php if (time() < strtotime($k['tanggal_habis_stnk'])) : ?>
              ...
              <td style="color: green;"> <?php echo date('d-M-Y', strtotime($k['tanggal_habis_stnk'])) ?> <br> belum jatuh tempo <br><?php echo round(date($belumjatuh / (60 * 60 * 24))) ?> hari dari sekarang</td>
            <?php elseif (time() > strtotime($k['tanggal_habis_stnk'])) : ?>
              <?php $sudahjatuh = time() - strtotime($k['tanggal_habis_stnk']) ?>
              <td style="color: red;"> <?php echo date('d-M-Y', strtotime($k['tanggal_habis_stnk'])) ?> <br> sudah jatuh tempo <br> <?= round(date($sudahjatuh / (60 * 60 * 24))) ?> hari yang lalu</td>
            <?php else :  ?>
              <td style="color: blue;"> baru hari ini jatuh tempo <br> <?= date('d-M-Y', strtotime($k['tanggal_habis_stnk'])) ?></td>
            <?php endif; ?>
